...
\begin{figure}
	...
	\caption[Simulando uma árvore 2-4] {Simulando uma operação de divisão na árvore 2-4
		...
		árvore 2-4 mostrada na \figref{twofour-add}.)}
	\figlabel{rb-split}
\end{figure}
...
\begin{prp}[inclinada para a esquerda]\prplabel{inclinada para a esquerda}\prplabel{redblack-last}

...
\pcodeonly{Nas nossas implementações em C++ e Java, o uso de funções que de cópia rápida de array}
...
\]
Deste modo, $#sqrttab#[i]$ está dentro de within 2 de $\sqrt{#x#}$ para todo
...
$\lfloor\sqrt{#x#}\rfloor-2$.  A oartir de #s# =podemos determinar o valor
...
seqüência exponencial cujo maior valor é no máximo $4\sqrt{#n#}$, então 
...
\emph{pro,ovido} multiplicando #x# por $2^{#r#-#r'#}$ e usando a equação
\[

\chapter{Red-Black Trees (Árvores Rubro-Negras)}
\chaplabel{redblack}
...
Consulte \figref{twofour-redblack}.
...
\index{árvore rubro-negra}%
\index{left-leaning árvore rubro-negra}%
...
que estão ilustradas em \figref{redblack-flippullpush}. As duas primeiras
